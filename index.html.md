...
<body>  
  ...
  <script>  
    ...
    // --- Gestione dati per mese con localStorage ---  
    ...
    function loadMonthData(month) {  
      ...
      if(data) {  
        ...
        // Se non ci sono dati, azzera residuo  
    ...
    function clearAllFields() {  
      ...
      // Aggiungi i tre campi iniziali per entrate e due per ogni tipo di spesa  
    ...
    function updateAllTotals() {  
      // Totali spese fisse e variabili  
    ...
    function updateSaldo() {  
      ...
      // Aggiorna residuo mese in memoria (ma non nel campo input)  
      saveCurrentMonthData(); // salva i dati correnti  
    }  
  
    // Aggiorna residuo mese precedente al cambio mese  
    function updateMonthlyResidual() {  
      // Residuo mese precedente = saldo mese precedente  
    ...
    document.getElementById('add-spesa-variabile').addEventListener('click', () => {  
      addSpesaVariabileField();  
      saveCurrentMonthData();  
    });  
  
    // Quando cambio residuo manualmente aggiornare tutto  
